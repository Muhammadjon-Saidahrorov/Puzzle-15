...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean continueLogic = false;
        setContentView(R.layout.activity_main);
        localStorge = LocalStorge.getInstance();
        localStorge.saveBoolean("CONTINUE", continueLogic);
        load();
        initViews();
        initNumbers();
        setNumbersToButton();
    ...
    protected void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        for (int i = 0; i < count; i++) {
            int x = i / size;
            int y = i % size;
            list.add((String) buttons[x][y].getText());
        }
        outState.putStringArrayList("SAVE", list);
    }
    ...
    protected void onRestoreInstanceState(@NonNull Bundle savedInstanceState) {
        ...
        list = savedInstanceState.getStringArrayList("SAVE");
        RelativeLayout containerButtons = findViewById(R.id.containerButtons);
        ...
        for (int i = 0; i < count; i++) {
            ...
            buttons[x][y].setText(list.get(i));
        }
        list.clear();
    }
